...
class CreateBotPage extends StatefulWidget {
  ...
  @override
  CreateBotPageState createState() => CreateBotPageState();
}

class CreateBotPageState extends State<CreateBotPage> {
          ...
          children: [
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                ...
                hintText: '4–20 characters: letters, numbers, dashes, periods, underscores.',
              ),
            ),
            const SizedBox(height: 16),
            const Text(
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                border: OutlineInputBorder(),
                hintText: 'Hi there! I\'m your travel assistant. How can I help you plan your next adventure today?',
              ),
            ),
            const SizedBox(height: 16),
            ElevatedButton(
